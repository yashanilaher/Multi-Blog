        ...
        {sports && sports.length>0 ? (
          <div>
            <p className="text-center mb-8">
              From thrilling victories to heartbreaking defeats, sports unite people and bring out the spirit of competition and teamwork.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
                {[...sports].reverse().slice(0,6).map((blog, index) => (
                  <Link
                    to={`/blog/${blog._id}`}
                    key={blog._id}
