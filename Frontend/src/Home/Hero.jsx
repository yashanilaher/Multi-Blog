...
const Hero = () => {
  ...
  return (
    <div>
      <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 px-10">
        {blogs && blogs.length > 0 ? (
          [...blogs].reverse().slice(0, 4).map((element) => {
            // console.log(element.adminName);
            return (
              <Link
                to={`/blog/${element._id}`}
                key={element._id}
              ...
              >
                <div className="relative group">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent opacity-75 group-hover:opacity-100 transition-opacity duration-300"></div>
